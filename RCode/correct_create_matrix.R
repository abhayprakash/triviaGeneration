# as discussed at https://groups.google.com/forum/#!topic/rtexttools-help/rAPvdljhlRQ
# there is a spelling mistake in original code, so creating an alternate with correction

create_matrix_correct <- function (textColumns, language = "english", minDocFreq = 1, 
